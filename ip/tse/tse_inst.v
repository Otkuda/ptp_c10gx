	tse u0 (
		...
		.rx_cdr_refclk      (_connected_to_rx_cdr_refclk_),      //   input,   width = 1,                 rx_cdr_refclk.clk
		...
		.rxp                (_connected_to_rxp_),                //   input,   width = 1,             serial_connection.rxp
		.txp                (_connected_to_txp_),                //  output,   width = 1,                              .txp
